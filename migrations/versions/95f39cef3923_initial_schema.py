...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'value', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
        sa.PrimaryKeyConstraint('id'),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column(
            'role',
            sa.Enum('STUDENT', 'ADMIN', 'MODERATOR', name='userrole'),
            nullable=False,
        ),
        sa.Column(
            'status',
            sa.Enum('CREATED', 'CONFIRMED', 'BANNED', name='userstatus'),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            'status',
            sa.Enum('CREATED', 'RESOLVED', 'REJECTED', name='complaintstatus'),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            'deal_type', sa.Enum('RENT', 'DORM', name='dealtype'), nullable=False
        ),
        sa.Column(
            'status',
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint(
            'profile_id', 'deal_id', name='unique_profile_deal_reaction'
        ),
    )
    op.create_table(
        'messages',
